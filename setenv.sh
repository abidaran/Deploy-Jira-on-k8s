JVM_SUPPORT_RECOMMENDED_ARGS='-Dhttp.proxyHost=172.17.11.2 -Dhttp.proxyPort=443 -Dhttps.proxyHost=172.17.11.2 -Dhttps.proxyPort=443 -Dhttp.nonProxyHosts=localhost'
#
